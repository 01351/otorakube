...
for tab, folder in zip(tabs, subfolders):
    with tab:
        ...
        def toggle_all_part():
            for p in existing_parts:
                st.session_state[f"part_{folder['id']}_{p}"] = st.session_state[f"all_part_{folder['id']}"]
        ...
        def toggle_all_type():
            for t in type_labels:
                st.session_state[f"type_{folder['id']}_{t}"] = st.session_state[f"all_type_{folder['id']}"]
